...
export default class AppIntroSlider extends React.Component {
    ...
    if (this.props.bottomButton) {
      content = (
        <View
          style={[
            styles.bottomButton,
            isSkip && { backgroundColor: 'transparent' }
          ]}
        >
          {content}
        </View>
  ...
  _renderNextButton = () => {
    let content = this.props.renderNextButton ? (
  ...
  _renderDoneButton = () => {
    let content = this.props.renderDoneButton ? (
      this.props.renderDoneButton()
    ) : (
      <Text style={styles.buttonText}>{this.props.doneLabel}</Text>
    );
    return this._renderButton(content, this.props.onDone && this.props.onDone);
  };

  _renderSkipButton = () => {
    let content = this.props.renderSkipButton ? (
      this.props.renderSkipButton()
    ) : (
      <Text style={styles.buttonText}>{this.props.skipLabel}</Text>
    );
